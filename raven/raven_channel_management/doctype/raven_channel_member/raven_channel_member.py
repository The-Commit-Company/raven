...
def get_channel_members_and_data(channel_id):
    ...
    data_query = (frappe.qb.from_(channel_data)
                  .select(channel_data.channel_name, channel_data.type, channel_data.creation, channel_data.owner, channel_data.is_direct_message, channel_data.is_self_message)
