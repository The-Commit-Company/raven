            ...
            {hasMany && (
                <div
                    ...
                    className={cn(
                        ...
                        "shrink-0 p-3 transition-opacity duration-150 max-md:absolute max-md:inset-x-0 max-md:bottom-0 max-md:z-20 max-md:pb-[calc(0.75rem+var(--safe-area-inset-bottom))]",
                        chromeHidden && "pointer-events-none opacity-0",
                    )}
