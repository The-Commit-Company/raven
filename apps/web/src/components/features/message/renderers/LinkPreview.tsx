                ...
                >
                    ...
                    <div className="gap-1.5 sm:p-0 py-3 px-3 flex-1">
                        <div className="sm:gap-1 gap-0.5">
                            <div className="font-semibold text-sm block text-ink-gray-7">{data.title}</div>
                            <div className="text-xs text-ink-gray-4">{data.site_name}</div>
                        </div>
                        <p className="text-xs text-ink-gray-4 mt-1.5 line-clamp-2">{data.description}</p>
                    </div>
                </a>
            </div>
            {onHide && (
