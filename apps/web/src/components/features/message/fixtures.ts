...
/**
 * Design-time fixture data for the message renderer components
 * (PollMessage, ImageMessage, FileMessage, MessageReactions, PollVotingMessage).
 * The components are wired to real data progressively — these fixtures keep
 * their designs previewable until then.
 */
...
export const dummyCurrentUserVotes = [{ option: "opt-1" }]
...
export const dummyCurrentUserVotes2 = [{ option: "opt-4" }]

export const dummyPoll3 = {
...
export const dummyCurrentUserVotes3 = [{ option: "opt-7" }]

// Poll 4: Anonymous single choice poll (user hasn't voted)
export const dummyPoll4 = {
...
export const dummyUsers: Record<string, UserData> = {
    "user1": {
        name: "Desirae Lipshutz",
        full_name: "Desirae Lipshutz",
        user_image: "https://randomuser.me/api/portraits/women/44.jpg",
...
// Dummy reactions
export const dummyReactions1: ReactionObject[] = [
    {
        reaction: "🎉",
...
export const dummyReactions2: ReactionObject[] = [
    {
        reaction: "👏",
...
export const dummyReactions3: ReactionObject[] = [
    {
        reaction: "😍",
        users: ["user1", "user3"],
        count: 2,
...
export const dummyReactions4: ReactionObject[] = [
    {
        reaction: "🚀",
...
export const dummyReactions5: ReactionObject[] = [
    {
        reaction: "✅",
        users: ["user1", "user2"],
        count: 2,
...
export const dummyReactionsImage: ReactionObject[] = [
    {
        reaction: "😍",
        users: ["user1", "user2", "user3"],
        count: 3,
