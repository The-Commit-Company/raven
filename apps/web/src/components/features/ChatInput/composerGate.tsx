...
const ComposerBlockedBanner = ({
    ...
    return <div className="md:px-3 md:pb-3 w-full">
        ...
        <div className="flex md:min-h-[98px] flex-col items-center justify-center gap-2 md:rounded-lg rounded-none md:border border-t border-outline-gray-2 bg-surface-gray-1 md:px-3 px-4 py-4 standalone:pb-[max(var(--safe-area-inset-bottom),1rem)] text-sm text-ink-gray-6">
