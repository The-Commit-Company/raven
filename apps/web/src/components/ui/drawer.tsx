        ...
        <DrawerPortal>
            ...
            <DrawerPrimitive.Content
                ...
                className={cn(
                    ...
                    "fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-xl border-t border-outline-gray-2 bg-surface-elevation-1 outline-none pb-[var(--safe-area-inset-bottom)]",
                    className
                )}
                {...props}
            >
