...
export const KeyboardKeyIcon = ({ key, ...props }: KeyboardKeyIconProps) => {
  switch (key) {
    case 'meta':
      return <KeyboardMetaKeyIcon {...props} />
    case 'shift':
      return <LuArrowBigUpDash {...props} />
    case 'ctrl':
      return <BiChevronUp {...props} />
    case 'alt':
      return <BsOption {...props} />
    case 'backspace':
      return <FiDelete {...props} />
    case 'del':
      return <FiDelete {...props} />
    case 'delete':
      return <FiDelete {...props} />
    case 'return':
      return <BsArrowReturnLeft {...props} />
    case 'enter':
      return <BsArrowReturnLeft {...props} />
    case 'space':
      return <BiSpaceBar {...props} />
    case 'tab':
      return <LuArrowRightToLine {...props} />
    case 'up':
      return <LuArrowBigUp {...props} />
    case 'down':
      return <LuArrowBigDown {...props} />
    case 'left':
      return <LuArrowBigLeft {...props} />
    case 'right':
      return <LuArrowBigRight {...props} />
  }
}
