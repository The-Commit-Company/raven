              ...
              <HStack align='center'>
                ...
                {bot.is_ai_bot ? (
                  <HoverCard.Root>
                    ...
                    <HoverCard.Content>
                      <Stack>
                        <BotFeatureRow enabled={bot.allow_bot_to_write_documents} label='Can Write Documents' />
                        <BotFeatureRow enabled={bot.enable_file_search} label='File Search' />
                        <BotFeatureRow enabled={bot.enable_code_interpreter} label='Code Interpreter' />
                        <BotFeatureRow enabled={bot.dynamic_instructions} label='Dynamic Instructions' />
                      </Stack>
                    </HoverCard.Content>
                  </HoverCard.Root>
                ) : null}
...
const BotFeatureRow = ({ enabled, label }: { enabled?: 0 | 1; label: string }) => {
  return (
    <HStack align='center'>
      ...
      <Text className='text-gray-12' size='2'>
        {label}
      </Text>
    </HStack>
  )
