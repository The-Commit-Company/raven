      ...
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <SettingsContentContainer>
            ...
            {isAIEnabled ? (
              <Box>
                <Label htmlFor='openai_organisation_id' isRequired>
            ...
            {isAIEnabled ? (
              <Box>
                <Label htmlFor='openai_api_key' isRequired>
                  OpenAI API Key
                </Label>
                <TextField.Root
                  className={'w-48 sm:w-96'}
            ...
            {isAIEnabled ? (
              <Box>
                ...
                <HelperText>If not set, the integration will use the default project.</HelperText>
              </Box>
            ) : null}

            {openaiVersion && (
              <Text color='gray' size='2'>
                OpenAI Python SDK Version: {openaiVersion.message}
              </Text>
            )}
          </SettingsContentContainer>
        </form>
