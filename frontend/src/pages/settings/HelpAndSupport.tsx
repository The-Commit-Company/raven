        ...
        <PageContainer>
            <SettingsContentContainer>
                ...
                <Stack gap="5">
                    ...
                    <Stack gap='0'>
                        {/* @ts-expect-error */}
                        <Text size='3' color='gray'><Text size='5' className="cal-sans text-gray-12 dark:text-white">raven</Text> <Code size='2' variant="ghost">v2.0.0{frappe?.boot.versions.raven}</Code></Text>
