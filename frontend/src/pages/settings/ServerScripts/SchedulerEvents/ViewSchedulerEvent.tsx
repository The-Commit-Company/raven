...
const ViewSchedulerEvent = () => {
  ...
  const {
    ...
    mutate,
    isLoading
  } = useFrappeGetDoc<RavenSchedulerEvent>('Raven Scheduler Event', ID)
...
const ViewSchedulerEventPage = ({ data, onUpdate }: { data: RavenSchedulerEvent; onUpdate: () => void }) => {
  ...
  const badges: HeaderBadge[] = data.disabled
              ...
              <HStack>
                <DropdownMenu.Root>
                  ...
                  <DropdownMenu.Content className='min-w-32'>
                    <DropdownMenu.Item onClick={onStatusToggle}>
