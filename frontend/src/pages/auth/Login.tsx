...
export const Component = () => {
  ...
  async function onSubmit(values: LoginInputs) {
    ...
    if (loginContext?.message?.two_factor_is_enabled) {
      ...
      return login({ username: values.email, password: values.password })
  ...
  return (
    <AuthContainer>
      ...
      {isTwoFactorEnabled ? (
        <TwoFactor
          loginWithTwoFAResponse={loginWithTwoFAResponse}
          setError={setError}
              ...
              <Flex direction='column' gap='4'>
                <Flex direction='column' gap='2'>
                  <Label htmlFor='email' isRequired size='3'>
                    {loginContext?.message?.login_label}
                  </Label>
                  <TextField.Root
                    {...register('email', {
                ...
                <Flex direction='column' gap='2'>
                  <Label htmlFor='password' isRequired size='3'>
                    Password
                  </Label>
                  <TextField.Root
                    {...register('password', {
                  ...
                  <Flex direction='column' gap='2' align='end'>
                    <LinkButton asChild color='gray' size='2'>
                ...
                <Flex direction='column' gap='2'>
                  <Button type='submit' disabled={isSubmitting} size='3' className='not-cal font-medium'>
              ...
              <Flex direction='column' key={i}>
                ...
                >
                  <Link to={soc.auth_url} className='flex items-center'>
                    {SocialProviderIcons[soc.name] ? (
                      SocialProviderIcons[soc.name]
                    ) : (
                      <img src={soc.icon.src} alt={soc.icon.alt} style={{ width: '20px', height: '20px' }}></img>
                    )}
