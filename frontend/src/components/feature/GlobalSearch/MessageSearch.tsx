  ...
  return (
    <Box>
      <Flex direction='column' gap='2'>
        <TextField.Root onChange={handleChange} type='text' placeholder='Search messages' value={searchText} autoFocus>
          ...
          !showResults && (
            <Box className='text-center' py='8'>
              <Text size='2' className='text-gray-11'>
                Add a search query above to see results.
              </Text>
            </Box>
          )
        )}
