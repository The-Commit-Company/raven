    ...
    <Tabs.Root defaultValue='general'>
      <Tabs.List>
        <Tabs.Trigger value='general'>
          <BiBoltCircle {...ICON_PROPS} /> General
        </Tabs.Trigger>
        <Tabs.Trigger value='fields'>
          <LuVariable {...ICON_PROPS} /> Fields
        </Tabs.Trigger>
      </Tabs.List>
      <Box pt='4'>
...
const GeneralTab = () => {
  const {
    ...
    setValue,
    watch
  } = useFormContext<RavenMessageAction>()
  ...
  return (
    <Stack gap='4'>
      <Grid columns={'2'} gap='4' align='center'>
        <Stack>
          <Box>
            <Label htmlFor='action_name' isRequired>
              Name
            </Label>
            <TextField.Root
              id='action_name'
        ...
        <Stack>
          <Box>
            <Label htmlFor='action' isRequired>
              Action Type
            </Label>
            <Controller
              control={control}
        ...
        {action === 'Create Document' && (
          <Stack>
            ...
            />
            <HelperText>The document you want this action to create.</HelperText>
        ...
        {action === 'Custom Function' && (
          <Stack>
            <Box>
              <Label htmlFor='custom_function_path' isRequired={action === 'Custom Function'}>
            ...
            <HelperText>Dotted path to the custom function/API. Cannot contain spaces.</HelperText>
        ...
        {action === 'Server Script' && (
          <Stack>
            ...
            <HelperText className='leading-6'>
              The Server Script you want this action to run. Server Scripts need to be of type "API".
              <br />
              {serverScript ? (
                <Link href={`/app/server-script/${serverScript}`} target='_blank'>
                  Configure {serverScript} <FiExternalLink />
                </Link>
              ) : (
                <Link href='/app/server-script/list' target='_blank'>
                  View Server Scripts <FiExternalLink />
                </Link>
              )}
            </HelperText>
      ...
      <Stack>
        <Box>
          ...
          <TextArea
            ...
            id='description'
            placeholder='Create a support ticket from the message.'
          />
        </Box>
...
const ViewDocsButton = () => {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        <Button className='not-cal' variant='outline'>
          <BiCodeAlt /> View Docs
        </Button>
      </Dialog.Trigger>
      <Dialog.Content>
