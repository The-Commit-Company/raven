...
export const MessageContent = ({ message, user, isThreadTitle = false, ...props }: MessageContentProps) => {

    return <Box {...props}>
        {message.text ? <TiptapRenderer message={{
            ...message,
            message_type: 'Text'
        }} user={user} isThreadTitle={isThreadTitle} showLinkPreview={message.hide_link_preview ? false : true} /> : null}
