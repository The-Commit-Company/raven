...
const ChatbotAIChatBox: React.FC<Props> = ({ session, onSendMessage, loading = false, onUpdateMessages }) => {
  ...
  return (
    <div className='h-full w-full bg-white dark:bg-[#212121] flex flex-col'>
      {/* Header */}
      <div className='border-b border-black/10 dark:border-white/10 px-4 py-3 bg-white dark:bg-[#212121]'>
      ...
      {/* Messages */}
      <div
        className='flex-1 overflow-y-auto bg-white dark:bg-[#212121]'
        onDrop={handleDrop}
      ...
      {/* Input Area */}
      <div className='border-t border-black/10 dark:border-white/10 bg-white dark:bg-[#212121] px-4 py-4'>
        <div className='max-w-3xl mx-auto'>
          ...
          >
            ...
            <div className='relative flex items-center gap-2 p-3 bg-white dark:bg-[#2f2f2f] border border-gray-200 dark:border-gray-600 rounded-2xl shadow-sm focus-within:border-gray-300 dark:focus-within:border-gray-500 focus-within:shadow-md transition-all'>
              ...
              <textarea
                ...
                className='flex-1 resize-none bg-transparent border-none outline-none text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-base leading-6 max-h-32 min-h-6 py-2'
                rows={1}
                disabled={loading}
                style={{
                  height: 'auto',
              ...
              <button
                ...
                className={`flex-shrink-0 p-2 rounded-lg transition-all ${
                  (!input.trim() && !selectedFile) || loading
                    ...
                    : 'text-white bg-gray-900 dark:bg-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 shadow-sm'
                }`}
              >
                <BiSolidSend size={18} />
              </button>
