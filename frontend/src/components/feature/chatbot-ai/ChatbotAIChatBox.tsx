      ...
      <div className="flex-1 overflow-y-auto p-4 text-sm text-gray-12">
        ...
        {isThinking && (
          <Flex justify="start" className="mb-2">
            <Box
              className="rounded-lg px-4 py-2 max-w-[70%] bg-gray-3"
              style={{ fontSize: '15px', lineHeight: '1.6' }}
            >
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-gray-10 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                <div className="w-2 h-2 bg-gray-10 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                <div className="w-2 h-2 bg-gray-10 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                <Text className="text-sm text-gray-10 ml-2">
                  AI đang suy nghĩ...
                </Text>
              </div>
            </Box>
