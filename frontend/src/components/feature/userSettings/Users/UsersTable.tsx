      ...
      <Table.Header>
        <Table.Row>
          <Table.ColumnHeaderCell>
            <Checkbox checked={isAllChecked} onCheckedChange={(e) => setAllChecked(e.valueOf() ? true : false)} />
          </Table.ColumnHeaderCell>
          ...
          return (
            <Table.Row key={index}>
              <Table.RowHeaderCell>
                <Checkbox
                  checked={isSelected}
                  disabled={defaultSelected.includes(user.name)}
                  onCheckedChange={() => onCheckboxChange(user.name)}
                />
              </Table.RowHeaderCell>
              <Table.Cell>
              ...
              <Table.Cell>
                <StandardDate date={user.creation} />
              </Table.Cell>
              <Table.Cell>
                {user.role_profile_name ? (
                  <Box>
                    <Tooltip
                      content={
                        <span>
                          A role profile has been assigned to this user.
                          <br />
                          If you want to add the user to Raven, please change their role profile.
                        </span>
                      }
                    >
