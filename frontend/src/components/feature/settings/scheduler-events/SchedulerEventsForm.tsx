...
export const SchedulerEventsForm = ({ edit = false }: Props) => {
  const {
    ...
    control,
    formState: { errors }
  } = useFormContext<SchedulerEventForm>()
  ...
  return (
    <Flex direction='column' gap={'4'}>
      ...
      {!edit && (
        <Stack>
          <Box>
            <Label htmlFor='event_name' isRequired>
              Name
            </Label>
            <TextField.Root
              {...register('event_name', {
                required: 'Name is required.',
                maxLength: { value: 140, message: 'Name cannot be more than 140 characters.' }
              })}
      ...
      <Grid columns={'2'} gap={'4'}>
        <Stack>
          <Box>
            <Label isRequired htmlFor='channel'>
                  ...
                  <Select.Content>
                    <Select.Group>
                      ...
                      {bots?.map((bot: any, index: number) => (
                        <Select.Item key={index} value={bot.name}>
                          {bot.name}
                        </Select.Item>
                      ))}
                    </Select.Group>
      ...
      <Grid columns={'2'} gap={'4'}>
        <Stack>
          <Box>
            <Label htmlFor='event_frequency' isRequired>
        ...
        <Box className='w-[350px]'>
          <Flex gap={'4'}>
            <Box>
              ...
              />
              {errors.hour && (
                <ErrorText className='pt-1' id='hour-error'>
                  {errors.hour.message}
                </ErrorText>
              )}
            </Box>
            <Box>
              <Label isRequired htmlFor='minute'>
                Minute
              </Label>
              <TextField.Root
                {...register('minute', {
              ...
              />
              {errors.minute && (
                <ErrorText className='pt-1' id='minute-error'>
        ...
        <Box>
          <Flex gap={'4'}>
            <Box>
              ...
              />
              {errors.date && (
                <ErrorText className='pt-1' id='date-error'>
                  {errors.date.message}
                </ErrorText>
              )}
            </Box>
      ...
      {frequency === 'Cron' && (
        <Box>
          <Label htmlFor='cron_format' isRequired>
      ...
      <Box>
        ...
        />
        {errors.content && (
          <ErrorText className='pt-1' id='content-error'>
...
const AdvancedCronInput = ({ name, label, ...props }: { name: string; label: string }) => {
  ...
  return (
    <Flex gap={'4'} width={'100%'}>
      ...
      <Box className='w-[20%]'>
        <Label isRequired htmlFor='month'>
          Month
        </Label>
        <TextField.Root
          {...props}
        ...
        />
        {errors.month && (
          <ErrorText className='pt-1' id='month-error'>
