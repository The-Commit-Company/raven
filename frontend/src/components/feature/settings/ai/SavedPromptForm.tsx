...
const SavedPromptForm = () => {
  const {
    ...
    control,
    formState: { errors }
  } = useFormContext<RavenBotAIPrompt>()
  ...
  return (
    <Stack gap='4'>
      ...
      <Stack>
        <Box>
          <Label htmlFor='prompt' isRequired>
            Prompt
          </Label>
          <TextArea
            id='prompt'
      ...
      <Stack maxWidth={'480px'}>
        ...
        <HelperText>If checked, this prompt will be available to all users on Raven</HelperText>
      </Stack>
      <Stack maxWidth={'480px'}>
        <LinkFormField
          name='raven_bot'
          ...
          doctype='Raven Bot'
        />
        <HelperText>If added, this prompt will only be shown when interacting with the agent</HelperText>
