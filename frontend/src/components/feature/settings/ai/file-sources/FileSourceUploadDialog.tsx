...
import { Box, Button, ButtonProps, Dialog, Spinner, TextField } from '@radix-ui/themes'
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Content>
        ...
        <Dialog.Description size='2'>Upload a file to use as a data source for AI Agents.</Dialog.Description>
...
const FileSourceUploadForm = ({ onClose }: { onClose: (id: string) => void }) => {
  ...
  return (
    <Stack gap='4'>
      ...
      <FileUploadBox file={file} onFileChange={onFileSelect} hideIfLimitReached maxFileSize={10} />
      <Stack>
        <Box>
          <Label htmlFor='file_name' isRequired>
            File Name
          </Label>
          <TextField.Root
            id='file_name'
