...
import { Box, Checkbox, Heading, Select, Separator, Text, TextField, Tooltip } from '@radix-ui/themes'
import { useFrappeGetCall } from 'frappe-react-sdk'
import { Controller, useFormContext } from 'react-hook-form'
import { BiInfoCircle } from 'react-icons/bi'

const AIFeaturesBotForm = () => {
  const {
    register,
    control,
    formState: { errors },
  ...
  return (
    <Stack gap='4'>
      ...
      <Separator className='w-full' />
      <Heading as='h5' size='2' className='not-cal' weight='medium'>
        Advanced
      </Heading>
      <Stack maxWidth={'560px'}>
        <Text as='label' size='2'>
  ...
  return (
    <Stack maxWidth={'480px'}>
      ...
      <HelperText>
        ...
        <br />
        The model should be compatible with the OpenAI Assistants API. We recomment using models in the GPT-4 family for
        best results.
      </HelperText>
    </Stack>
  )
