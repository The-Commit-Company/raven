...
const GeneralFunctionDetails = ({ isEdit }: { isEdit?: boolean }) => {
  const {
    ...
    formState: { errors },
    setValue
  } = useFormContext<RavenAIFunction>()
  ...
  const onFunctionChange = (event: ChangeEvent<HTMLSelectElement>) => {
    ...
    if (event.target.value === 'Attach File to Document') {
      ...
      setValue(
        'description',
        'This function attaches a file to a document in the system. Call this function after you have created or updated the document.'
      )
    }
  ...
  return (
    <Stack gap='4'>
      <Grid columns={'2'} gap='4'>
        ...
        <Stack>
          <Box>
            <Label htmlFor='function_name' isRequired>
              Name
            </Label>
            <TextField.Root
              id='function_name'
...
const PassParamsAsJSON = () => {
  ...
  return (
    <Stack maxWidth={'480px'}>
      ...
      <HelperText>If checked, the params will be passed as a JSON object instead of named parameters</HelperText>
    </Stack>
  )
}
...
const RequiresWritePermissions = () => {
  ...
  return (
    <Stack maxWidth={'480px'}>
      ...
      <HelperText>Check this if the function you have selected requires write permissions.</HelperText>
    </Stack>
  )
}
...
const CustomFunction = () => {
  ...
  return (
    <Stack>
      <Box>
        <Label htmlFor='function_path' isRequired={type === 'Custom Function'}>
...
const ReferenceDoctypeField = () => {
  ...
  return (
    <Stack>
      ...
      />
      <HelperText>The document you want this function to operate on.</HelperText>
