...
export const QUICK_ACTION_BUTTON_CLASS = 'bg-[var(--gray-2)] dark:bg-[var(--gray-3)] hover:bg-[var(--gray-4)] dark:hover:bg-[var(--gray-6)] text-[var(--gray-12)] hover:text-[var(--gray-12)]'
