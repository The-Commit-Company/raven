...
export const ViewChannelDetailsModal = ({ isOpen, onClose, loggedinUsers }: ViewChannelDetailsModalProps) => {
                ...
                <ModalBody>
                    ...
                    <Tabs h='60vh' defaultIndex={1}>
                        ...
                        <TabPanels>
                            ...
                            <TabPanel px={0}>
                                <ChannelMemberDetails members={members} loggedinUsers={loggedinUsers} />
                            </TabPanel>
                        </TabPanels>
                    </Tabs>
