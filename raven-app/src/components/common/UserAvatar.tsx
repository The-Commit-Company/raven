...
export const UserAvatar = ({ src, alt, size = '1', radius = 'medium', isActive, fallback, ...props }: UserAvatarProps) => {
    ...
    return <span ref={ref} className="relative inline-block">
        {inView ?
            ...
            : <Skeleton className={radixRadiusToTailwind(radius)} width={size} height={size} />}
        {isActive &&
